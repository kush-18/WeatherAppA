package com.example.weatherappa.Activities
...
import com.example.weatherappa.Models.WeatherModel
import com.example.weatherappa.R
import com.example.weatherappa.Utilites.ApiUtilities
import com.example.weatherappa.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private val apiKey="cac166ce01f8e0eb3e56db6a9ee1b8d3"
    ...
    private fun setData(body:WeatherModel){
        ...
        binding.apply {
            ...
            weatherTittle.text=body.weather[0].main
